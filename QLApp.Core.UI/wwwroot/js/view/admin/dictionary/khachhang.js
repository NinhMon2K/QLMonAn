...
class KhachHang {
    ...
    loadKhachHang() {
        ...
        AppAjax.Ajax(this.callApi('LoadKhachHang'), {}, {}, function (data) {
            var contentTables = $('.customer-kh');
         ...
         <td class='check-box-index ck_All'><input type='checkbox' class='check_item' name='' value='' onclick="changeCheck('${data.Id_KH}')"> </td>
                        ...
                        <td class='ck_All'><i class='ti-trash'></i></td>
                        <td class='ck_All'><i class='ti-write'></i></td>
                         `;
